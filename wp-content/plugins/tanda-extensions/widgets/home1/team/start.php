...
if ( ! class_exists( 'team_section_start' ) ) {

    class team_section_start {
        ...
        */
        public function __construct() {
            ...
            add_shortcode( 'home1-team-section-start-shortcode', array( 'team_section_start', 'output' ) );

            // Map shortcode to Visual Composer
            if ( function_exists( 'vc_lean_map' ) ) {
                vc_lean_map( 'home1-team-section-start-shortcode', array( 'team_section_start', 'map' ) );
            }
    ...
    * This is an array of all your settings which become the shortcode attributes ($atts)
        ...
        */
        public static function map() {
            return array(
                'name'        => esc_html__( 'Team Section Start', 'tanda' ),
